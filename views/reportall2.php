...
<div class="centercontent tables">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">REPORTS VALUE</h1>
            <span class="pagedesc">There are all reports from sector</span>
            
        </div><!--pageheader-->
         <div class="overviewhead">
			<div class="overviewselect">
				<select id="overviewselect3" name="sector_new">
  ...
  <div id="contentwrapper" class="contentwrapper">                                
            ...
            <div class="contenttitle2">
				<h3>All Reports in Exploitations Phase</h3>
			</div>
			<?php
				if(isset($_GET['sector_new']))
					$tasks = $t->getReportsExploitations($_GET['sector_new']);
				else
					$tasks = $t->getReportsExploitations();
			?>
