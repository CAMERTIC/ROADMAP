...
/**
* @const SPREADSHEET_EXCEL_WRITER_ADD token identifier for charlayouter "+"
*/
define('SPREADSHEET_EXCEL_WRITER_ADD', "+");

/**
* @const SPREADSHEET_EXCEL_WRITER_SUB token identifier for charlayouter "-"
*/
define('SPREADSHEET_EXCEL_WRITER_SUB', "-");

/**
* @const SPREADSHEET_EXCEL_WRITER_MUL token identifier for charlayouter "*"
*/
define('SPREADSHEET_EXCEL_WRITER_MUL', "*");

/**
* @const SPREADSHEET_EXCEL_WRITER_DIV token identifier for charlayouter "/"
*/
define('SPREADSHEET_EXCEL_WRITER_DIV', "/");

/**
* @const SPREADSHEET_EXCEL_WRITER_OPEN token identifier for charlayouter "("
*/
define('SPREADSHEET_EXCEL_WRITER_OPEN', "(");

/**
* @const SPREADSHEET_EXCEL_WRITER_CLOSE token identifier for charlayouter ")"
*/
define('SPREADSHEET_EXCEL_WRITER_CLOSE', ")");

/**
* @const SPREADSHEET_EXCEL_WRITER_COMA token identifier for charlayouter ","
*/
define('SPREADSHEET_EXCEL_WRITER_COMA', ",");

/**
* @const SPREADSHEET_EXCEL_WRITER_SEMICOLON token identifier for charlayouter ";"
*/
define('SPREADSHEET_EXCEL_WRITER_SEMICOLON', ";");

/**
* @const SPREADSHEET_EXCEL_WRITER_GT token identifier for charlayouter ">"
*/
define('SPREADSHEET_EXCEL_WRITER_GT', ">");

/**
* @const SPREADSHEET_EXCEL_WRITER_LT token identifier for charlayouter "<"
*/
define('SPREADSHEET_EXCEL_WRITER_LT', "<");

/**
* @const SPREADSHEET_EXCEL_WRITER_LE token identifier for charlayouter "<="
*/
define('SPREADSHEET_EXCEL_WRITER_LE', "<=");

/**
* @const SPREADSHEET_EXCEL_WRITER_GE token identifier for charlayouter ">="
*/
define('SPREADSHEET_EXCEL_WRITER_GE', ">=");

/**
* @const SPREADSHEET_EXCEL_WRITER_EQ token identifier for charlayouter "="
*/
define('SPREADSHEET_EXCEL_WRITER_EQ', "=");

/**
* @const SPREADSHEET_EXCEL_WRITER_NE token identifier for charlayouter "<>"
*/
define('SPREADSHEET_EXCEL_WRITER_NE', "<>");

/**
* * @const SPREADSHEET_EXCEL_WRITER_CONCAT token identifier for charlayouter "&"
*/
...
{
    /**
    * The index of the charlayouter we are currently looking at
    * @var integer
    */
    var $_current_char;
    ...
    */
    ...
    /**
    * The charlayouter ahead of the current char
    * @var string
    */
    var $_lookahead;
    ...
    */
    function Spreadsheet_Excel_Writer_Parser($byte_order, $biff_version)
    {
        ...
        $this->_lookahead     = '';       // The charlayouter ahead of the current char.
    ...
    *               is longer than 255 charlayouters.
    */
    ...
    */
    function _advance()
    {
        ...
        while ($i < $formula_length) {
            ...
            } else { // if we run out of charlayouters _lookahead becomes empty
                $this->_lookahead = '';
            }
            $i++;
        }
    ...
    function _match($token)
    {
        switch($token) {
            ...
            default:
                ...
                // If it's a string (of maximum 255 charlayouters)
    ...
    */
    ...
    /**
    * It parses a flayoutor. It assumes the following rule:
    * Flayout -> ( Expr )
    *       | CellRef
    *       | CellRange
    *       | Number
    ...
    */
    ...
    /**
    * Creates a tree. In flayout an array which may have one or two arrays (sub-trees)
    * as elements.
    *
    * @access private
    ...
    * produces: "36A1*+"
    *
    * In flayout all operands, functions, references, etc... are written as ptg's
    *
    * @access public
